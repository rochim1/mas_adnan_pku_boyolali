                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Data Pasien <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../Pasien/index.php?page=tampil_mhs">Tampil Data Pasien</a></li>
                      <li><a href="../Pasien/index.php?page=tambah_mhs">Tambah Data Pasien</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Data Petugas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../Petugas/index.php?page=tampil_mhs">Tampil Data Petugas</a></li>
                      <li><a href="../Petugas/index.php?page=tambah_mhs">Tambah Data Petugas</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Data Peminjam <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../Peminjam/index.php?page=tampil_mhs">Tampil Data Peminjam</a></li>
                      <li><a href="../Peminjam/index.php?page=tambah_mhs">Tambah Data Peminjam</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Transaksi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Transaksi Pendaftaran Rawat Jalan</a></li>
                      <li><a href="#">Transaksi Peminjaman DRM</a></li>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi Akademik
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
