...
<div class="container" style="margin-top:20px">
  <center>
    <font size="6">Laporan Data Pengembalian</font>
  </center>
  <hr>
...
<div class="table-responsive mt-2">
  <table aria-label="Laporan Data Pengembalian" id="myTable" class="table table-striped jambo_table bulk_action">
    <thead>
      <tr>
        <th>No</th>
        <th>No RM</th>
    ...
    <tbody>
      ...
      if (isset($_POST['submit'])) {
        ...
        $sampai = $_POST['sampai'];
        // echo $dari.$sampai;
        $sql = mysqli_query($koneksi, "SELECT * FROM pinjam_kembali WHERE tanggal_pengembalian BETWEEN '$dari' AND '$sampai' ORDER BY kd_pinjam_kembali ASC") or die(mysqli_error($koneksi));
      } else {
