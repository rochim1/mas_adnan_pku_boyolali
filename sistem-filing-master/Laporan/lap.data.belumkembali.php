...
<div class="container" style="margin-top:20px">
  <center>
    <font size="6">Laporan Data Belum Kembali</font>
  </center>
  <hr>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="dashboard.php?page=cetak_data_blm_kembali">
...
<div class="table-responsive mt-2">
  <table aria-label="Laporan Data Belum Kembali" id="myTable" class="table table-striped jambo_table bulk_action">
    <thead>
      <tr>
        <th>No</th>
        <th>KD Pinjam</th>
