...
<div class="container" style="margin-top:20px">
	<center>
		<font size="6">Detail Peminjaman</font>
	</center>
	...
	<form action="dashboard.php?page=edit_peminjaman_DRM&no_pinjam=<?php echo $no_pinjam; ?>" method="post">
		...
		<div class="item form-group">
			...
			<div class="col-md-6 col-sm-6 ">
				<input disabled type="text" name="no_pinjam" class="form-control" size="4" value="<?php echo $data['no_pinjam']; ?>" readonly required>
			</div>
		</div>
		<div class="item form-group">
		...
		<div class="item form-group">
			<div class="col-md-6 col-sm-6 offset-md-3">
				<a href="dashboard.php?page=tampil_haruskembali" class="text-white btn btn-primary">Kembali</a>
			</div>
			<!-- asdasdasd -->
	</form>
</div>